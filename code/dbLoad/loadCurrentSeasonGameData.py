...
def dataQualityAdjustments(compactData, detailedData):
    ...
    # TODO - since switching to inserting games by day, we always have to \
    # adjust the compact date to the detailed date or else the scrape will miss it \
    # Resulting in re-scraping the compact date over and over
    compactData.loc[
    ...
    compactData.loc[
        (compactData['TmID'] == 1229) &
        (compactData['OppID'] == 1179) &
        (compactData['GameDate'] == '2020-01-15'), 'GameDate'] = '2020-01-16'
    compactData.loc[
        (compactData['TmID'] == 1179) &
        (compactData['OppID'] == 1229) &
        (compactData['GameDate'] == '2020-01-15'), 'GameDate'] = '2020-01-16'

    # Army vs Holy Cross
    compactData.loc[
        (compactData['TmID'] == 1221) &
        (compactData['OppID'] == 1119) &
        (compactData['GameDate'] == '2020-01-15'), 'GameDate'] = '2020-01-16'
    compactData.loc[
        (compactData['TmID'] == 1119) &
        (compactData['OppID'] == 1221) &
        (compactData['GameDate'] == '2020-01-15'), 'GameDate'] = '2020-01-16'

    # Hawaii vs Cal Poly
    compactData.loc[
        (compactData['TmID'] == 1142) &
        (compactData['OppID'] == 1218) &
        (compactData['GameDate'] == '2020-01-17'), 'GameDate'] = '2020-01-16'
    compactData.loc[
        (compactData['TmID'] == 1218) &
        (compactData['OppID'] == 1142) &
        (compactData['GameDate'] == '2020-01-17'), 'GameDate'] = '2020-01-16'
