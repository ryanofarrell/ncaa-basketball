...
def load_kaggle_data():
    ...
    rsgc = pd.read_csv('data/Stage2DataFiles/RegularSeasonCompactResults.csv')
    rsgd = pd.read_csv('data/Stage2DataFiles/RegularSeasonDetailedResults.csv')

    seasons = pd.read_csv(filepath_or_buffer = 'data/Stage2DataFiles//Seasons.csv')
    teams = pd.read_csv(filepath_or_buffer = 'data/Stage2DataFiles//Teams.csv')
    ...
    #db.games.drop()
    data = rsg.to_dict('records')
    db.games.insert_many(data[1:50],ordered=False)
